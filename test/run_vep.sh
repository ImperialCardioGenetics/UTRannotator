...
vep -i test_grch38.vcf --database --species --assembly GRCh38 --plugin UTRannotator,../uORF_starts_ends_GRCh38_PUBLIC.txt --tab --force_overwrite -o test_output_grch38.txt
